...
## 主要产品线：
1. **锐视测控平台**：集成开源软硬件解决方案
   - SignalPanel：图形化用户界面工具
   - JYDM：设备管理工具
   - SeeSharpTools：开发工具包
2. **USB-1601**：便携式数据采集设备
3. **PXI模块**：高性能模块化仪器
4. **AI增强工具**：AI Agent智能助手
...
## 主要产品分类：
### 数据采集类：
- **PXI-6251**：16位，1.25 MS/s，16路模拟输入，适合通用数据采集
- **PXI-6289**：18位，625 kS/s，32路模拟输入，适合高精度测量
- **USB-1601**：便携式数据采集，适合现场测试

### 信号发生类：
- **PXI-5421**：16位任意波形发生器，100 MS/s更新率
- **PXI-5422**：高速任意波形发生器，200 MS/s更新率

### 数字I/O类：
- **PXI-6552**：高速数字I/O，100 MHz时钟
- **PXI-6570**：数字波形仪器，1 GHz时钟
